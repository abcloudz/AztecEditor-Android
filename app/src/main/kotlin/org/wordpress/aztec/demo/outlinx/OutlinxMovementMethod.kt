...
import org.wordpress.aztec.TaskListClickHandler
import org.wordpress.aztec.demo.outlinx.span.MediaClickableSpan
import org.wordpress.aztec.spans.AztecMediaClickableSpan
import org.wordpress.aztec.spans.AztecURLSpan
import org.wordpress.aztec.spans.UnknownClickableSpan

object OutlinxMovementMethod : ArrowKeyMovementMethod() {
    ...
    override fun onTouchEvent(widget: TextView, text: Spannable, event: MotionEvent): Boolean {
        ...
        if (action == MotionEvent.ACTION_UP) {
            ...
            if (link != null) {
                if (link is AztecMediaClickableSpan || link is UnknownClickableSpan || link is MediaClickableSpan) {
                    link.onClick(widget)
                    return true
